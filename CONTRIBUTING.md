...
Welcome to `matsci-opt-benchmarks` contributor's guide.
...
If you experience bugs or general issues with `matsci-opt-benchmarks`, please have a look
...
You can help improve `matsci-opt-benchmarks` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`matsci-opt-benchmarks` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `matsci-opt-benchmarks`'s files. While this mechanism can
...
```
conda create -n matsci-opt-benchmarks python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/matsci-opt-benchmarks.git
   cd matsci-opt-benchmarks
   ```
...
5. Install [pre-commit]:
   ...
   `matsci-opt-benchmarks` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/matsci-opt-benchmarks
[issue tracker]: https://github.com/<USERNAME>/matsci-opt-benchmarks/issues
